...
Proof.
  ...
  - right. inversion Ht; subst.
    ...
    destruct H2, H4.
    + inversion H; subst.
      Check canonical_forms_fun.
      ++ eexists. econstructor. assumption.
      ++ inversion Ht; subst.
         inversion H4.
      ++ inversion Ht; subst.
         inversion H4. 
  ...
  - right.
    ...
    + destruct H.
      exists <{ if x0 then t2 else t3 }>. constructor. assumption.
Qed.
(** [] *)
...
Proof.
  ...
  - destruct (eqb_spec x x0); subst.
    + constructor.
      ...
      rewrite update_shadow in IHHt.
      inversion Ht; subst; try constructor; try assumption.
    + constructor.
      apply IHHt.
      rewrite update_permute; auto.
Qed.
